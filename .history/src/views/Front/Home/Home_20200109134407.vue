          ...
          <el-card class="box-card" :body-style="{ padding: '5px' }">
            ...
            <el-tabs v-model="activeName" @tab-click="handleClick" :stretch="true" class="loginHeight">
              <el-tab-pane label="我有需求" name="first">
                   <el-button class="xqelbuttonleft" type="success" round>协同设计</el-button>
                   <el-button class="xqelbuttonright" type="info" round>企业标准</el-button>
                   <el-button class="xqelbuttonleft" style="margin-top:10px" type="warning" round>综合服务</el-button>
                   <el-button class="xqelbuttonright" style="margin-top:10px ;" type="danger" round>产业融合</el-button>
              </el-tab-pane>
...
.xqelbuttonleft
{
  float: left; margin-left:0px ; position:relative;left:20px;
}
.xqelbuttonright
{
  float: right; margin-left:0px; position:relative;right:20px;
}
