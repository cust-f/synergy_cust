        ...
        <div class="bg-purple-dark grid-content">
          <el-card class="box-card" :body-style="{ padding: '5px' }">
            <div slot="header" class="clearfix0">
              ...
              <div class="clearfix0">
              <el-button style="float: left; padding: 10px 25px 10px 25px"  type="primary">登录</el-button>
              <el-button style="float: right; padding: 10px 25px 10px 25px" type="primary">注册</el-button>
              </div>
            </div>
        ...
        <div class="grid-content2 ">
          <el-card class="grid-content2 ">
            <div slot="header" class="titleColor">
              <div class="list_top cg_top"><img src="http://www.hccstc.cn:80/pages/jszy/images/jszy_img15.png">
              <a class="list_top_a1">最新成果</a><a href="http://www.hccstc.cn:80/technology/kjcgPage" target="_blank" class="list_top_a2">
              更多&gt;&gt;</a></div>
            </div>
