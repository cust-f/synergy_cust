        ...
        <div class="bg-purple-dark grid-content">
          <el-card class="box-card" :body-style="{ padding: '5px' }">
            <div slot="header" class="clearfix0">
              ...
              <div class="clearfix0">
              <el-button style="float: left; padding: 0px 25px 0px 25px"  type="primary">登录</el-button>
              <el-button style="float: right; padding: 0px 25px 0px 25px" type="primary">注册</el-button>
              </div>
            </div>
