...
export default {
  ...
  data() {
    return {
      ...
      demandTaskList:
      [
        {category:"交通运输",companyName:"一汽",name:"危险品运输半挂车货箱采购项目",sTime:"2019-09-06"},
        {category:"仪器仪表",companyName:"一汽",name:"LTE-V数据协议及性能测试设备",sTime:"2019-09-06"},
        {category:"电气机械",companyName:"哈工",name:"数据中心采暖系统改造项目",sTime:"2019-09-06"},
        {category:"通信设备",companyName:"一汽",name:"TNGA（2.5L）项目组装线安装工程",sTime:"2019-09-06"},
        {category:"通信设备",companyName:"哈工",name:"TNGA（2.5L）项目组装线安装工程",sTime:"2019-09-06"},
        {category:"仪器仪表",companyName:"一汽",name:"LTE-V数据协议及性能测试设备",sTime:"2019-09-06"},
        {category:"通信设备",companyName:"哈工",name:"TNGA（2.5L）项目组装线安装工程",sTime:"2019-09-06"},
        {category:"工程",companyName:"一汽",name:"数据中心采暖系统改造项目",sTime:"2019-09-06"},
        {category:"工程",companyName:"一汽",name:"数据中心采暖系统改造项目",sTime:"2019-09-06"},
        {category:"安装",companyName:"哈工",name:"TNGA（2.5L）项目组装线安装工程",sTime:"2019-09-06"},
        {category:"工程",companyName:"一汽",name:"数据中心采暖系统改造项目",sTime:"2019-09-06"},
        {category:"工程",companyName:"一汽",name:"数据中心采暖系统改造项目",sTime:"2019-09-06"},
        {category:"安装",companyName:"哈工",name:"TNGA（2.5L）项目组装线安装工程",sTime:"2019-09-06"},
