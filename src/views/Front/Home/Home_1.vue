  ...
  <div>
    <el-carousel trigger="click" height="500px" @change="loadAnimate">
      <el-carousel-item v-for="(item,index) in sliderList" :key="index">
        <figure>
          <img src="../../assets/img/slider/slider01.jpg" alt="没出来" width="100%" />
          <figcaption>
            <h1 :class="{ bounceInDown:slider_index==index }">{{ item.title }}</h1>
            <br />
            <p :class="{ fadeInUp:slider_index==index }">{{ item.abstract }}</p>
            <br />
            <router-link :to="item.link">
              <el-button
                class="slider-button"
                round
                :class="{ fadeInUp:slider_index==index }"
              >了解详情 >></el-button>
            </router-link>
          </figcaption>
        </figure>
      ...
      <ul>
        <li v-for="(item,index) in services" :key="index">
          <div class="service-box">
            <img :src="`../../assets/img/services/${index+1}.jpg`" />
      ...
      <div class="friends-container">
        ...
        <ul>
          <li v-for="item in 6" :key="item">
            <img :src="`../../assets/img/friends/clients-logo0${item}.png`" />
          </li>
        </ul>
      </div>
    </div>
      ...
      sliderList: [
        {
          title: "加盟宁夏节能，开启财富之门",
          abstract: "诚邀您的加盟",
          img: require("../../assets/img/slider/slider01.jpg"),
          link: ""
        },
        {
          title: "智慧能管平台",
          abstract: "基于物联网、大数据、区块链等先进技术",
          img: require("../../assets/img/slider/slider02.jpg"),
          link: ""
        },
        {
          title: "能源服务大厅",
          abstract: "根据地式能源服务，快速高效响应服务",
          img: require("../../assets/img/slider/slider03.jpg"),
          link: ""
        }
      ],
      kind: [
...
.home-friends {
  ...
  height: 35vh;
  padding: 20px 0;
  background: url(../../assets/img/head-view/clients-bg.jpg);
