      ...
      <el-dialog title="发布需求" :visible.sync="dialogVisible" > 
        <el-form ref="form" :model="form" :rules="rules" label-width="80px" class="" size="medium">
          ...
          <el-form-item label="需求类别">
              <el-select  v-model="form.value"  clearable size="medium" filterable placeholder="选择/输入需求大类" @change="selectOne">
                <el-option
              ...
              <el-select v-model="form.value0"  clearable size="medium" filterable placeholder="选择/输入需求子类">
                <el-option
                  v-if="show0"
