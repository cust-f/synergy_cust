  ...
  <div class="BG">
    ...
    <el-row :gutter="gutterCount" >
      <el-col :span="10"  :push="pushCount" :pull="pullCount">
        ...
        <h2 style="margin:20px 0;">冲压器具设计</h2>
        <el-divider></el-divider>
        <div class="grid-content3" style="margin-top:50px">      
          
          <p style =" width :50%; float:left">任务类型：交通运输设备</p>
          <p style =" width :50%;float:left">所在城市：吉林省长春市</p>
          
          <p>&nbsp;</p>
          <p style =" width :50%; float:left">联系方式：4006917888</p>
          <p style =" width :50%; float:left">发布时间：2019-10-21</p>
          <p>&nbsp;</p>
          <p style =" width :50%; float:left">任务开始时间：2019-10-22</p>
    ...
    <el-row :gutter="gutterCount">
     <el-col :span="16"  :push="pushCount" :pull="pullCount">
         <div class="grid-content5 bg-purple-dark">
           <h3 style="margin-top:-80px;margin-left:5px; padding: 0 10px; border-left: 3px solid #ff5500;">任务介绍</h3>
           <el-divider></el-divider>
