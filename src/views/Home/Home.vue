...
<template>
  <div class="BG">
    ...
    <el-row :gutter="gutterCount">
      ...
      <el-col :span="6" :push="pushCount0">
        <div class="grid-content bg-purple-dark">
          <div id="releaseDemandTop5" ref="chart" style="width: 600px;height:400px;"></div>
        </div>
      </el-col>
      ...
      demandTaskList: [
        {
          category: "2333",
          companyName: "6666",
          name: "6666666666666666666666666666666666666666666666666666666",
          sTime: "2019-09-06",
          eTime: "2019-12-31"
        },
        {
  ...
  methods: {
    ...
    getCharts3() {
      ...
      var myChart = echarts.init(
        document.getElementById("totalSupplyAndDemandTop5")
      );
      var option = {
        title: {
          text: "企业当年供需总量Top5",
