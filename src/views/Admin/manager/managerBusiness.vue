        ...
        <div>
          <div class="container">
            ...
            >
              ...
              <el-table-column prop="type" width="96" label="企业类型"></el-table-column>
              <el-table-column prop="time" width="99" label="注册时间"></el-table-column>
              <el-table-column prop="capital" width="84" label="企业资本"></el-table-column>
              <el-table-column prop="area" width="107" label="所在地区"></el-table-column>
              <el-table-column prop="contact"  w idth="128" label="联系方式"></el-table-column>
