    ...
    <el-container>
      <el-main>
            ...
            <el-row>
              <el-col :span="22">
                <el-form-item label="详细">
                  <el-input  type="textarea" v-model="form.Introduction" class="gongsiDetail" :disabled="true"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
          </el-form>
        ...
        <div align="center">
          ...
          >审核通过</el-button>
          <el-button type="danger" round class="button1" @click="open" :disabled="butongugo">审核未通过</el-button>
        </div>
      </el-main>
    </el-container>
