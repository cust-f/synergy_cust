...
<template>
  <div class="contractManagement">
    ...
    >
      ...
      <el-table-column prop="contractState" width="120" align="center" label="合同审核状态">
      ...
      <el-form ref="form" :model="addList3" label-width="0px">
        <el-row>
          <el-col :span="24" style="width:100%">
            <el-form-item>
              <el-input type="textarea" rows="6" v-model="addList3.contractRefuseReason" :readonly="true" placeholder="已拒绝"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
