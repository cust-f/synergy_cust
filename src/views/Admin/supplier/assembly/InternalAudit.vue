...
<template>
  <div class="InternalAudit">
    ...
    <!-- 拒绝设计原因 -->
    <el-dialog :visible.sync="designRefuseReason" class="refuseDialog">
      ...
      <el-form ref="applyList4" :model="addList4" label-width="0px">
        <el-row>
          <el-col :span="24" style="width:100%">
            <el-form-item>
              <el-input type="textarea" rows="6" v-model="addList4.SJrefuseReason" placeholder="请输入设计拒绝原因" autocomplete="off"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
