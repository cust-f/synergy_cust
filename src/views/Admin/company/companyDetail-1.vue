        ...
        <el-dialog :visible.sync="addVisible" width="50%">
          ...
          <el-col :span="11" style="margin-left:5px">
            ...
            <div>
              ...
              <el-upload
                :action="serverUrl"
                :file-list="tRCertificatePicture"
                list-type="picture"
                :auto-upload="false"
                ref="uploadBusinessLicense"                
                accept=".jpg, .png"
    ...
    getPictureDate() {
      ...
      that
        ...
        .then(response => {
          ...
          this.businessLicenseImageUrl=response.data.allData.companyPicture;
          this.businessPicture=response.data.allData.businessPicture;
          this.tRCertificatePicture=response.data.allData.tRCertificatePicture;         
