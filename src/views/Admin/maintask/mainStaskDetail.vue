      ...
      <div v-show="milepostActive4">
        ...
        >
          ...
          <el-table-column prop="demandorCheckDesignTime" label="审核时间">
            <template slot-scope="scope">
              <el-span v-if="+scope.row.demandorCheckDesignTime === 0"
                >暂未审核</el-span
              >
              <el-span v-else>{{
                scope.row.demandorCheckDesignTime | formatDate
              }}</el-span>
            </template>
          </el-table-column>
          <el-table-column label="操作" width="150" align="center">
            <template slot-scope="scope">
              ...
              <el-button
                ...
                size="small"
                v-if="
                  scope.row.demandorCheckDesignState === 1 ||
                  scope.row.demandorCheckDesignState === 2 ||
                  scope.row.demandorCheckDesignState === 3
                "
                >查看设计</el-button
              >
              <el-button
...
export default {
  ...
  methods: {
    ...
    handleAvatarSuccess(response, file, fileList) {
      ...
      console.log(
        "this.technicalFileWanzheng" + this.technicalFileWanzheng.length
      );
...
>>>>>>> 9f0725a47a1afc98ba2b9d8ace98f9de1b67a30d
